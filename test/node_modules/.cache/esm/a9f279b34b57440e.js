let Color,Galaxy,EngineCard;_4b5‍.x([["ONE",()=>ONE],["ZERO",()=>ZERO],["PLUS",()=>PLUS],["MINUS",()=>MINUS],["PSI_PLUS",()=>PSI_PLUS],["PSI_MINUS",()=>PSI_MINUS],["PHI_PLUS",()=>PHI_PLUS],["PHI_MINUS",()=>PHI_MINUS],["OMEGA0",()=>OMEGA0],["OMEGA1",()=>OMEGA1],["OMEGA2",()=>OMEGA2],["OMEGA3",()=>OMEGA3],["CLOCKWISE_TABLE",()=>CLOCKWISE_TABLE]]);_4b5‍.w("./Util",[["Color",["Color"],function(v){Color=v}],["Galaxy",["Galaxy"],function(v){Galaxy=v}]]);_4b5‍.w("./Engine",[["EngineCard",["EngineCard"],function(v){EngineCard=v}]]);
...
class Planet {
    ...
    get_transition_function(engine_card, color) {
       ...
       const ONE = new Planet('ONE', Galaxy.Centarious);
       const ZERO = new Planet('ZERO', Galaxy.Centarious);

       const PLUS = new Planet('PLUS', Galaxy.Superious);
       const MINUS = new Planet('MINUS', Galaxy.Superious);

       const PSI_PLUS = new Planet('PSI PLUS', Galaxy.Entanglion);
       const PSI_MINUS = new Planet('PSI MINUS', Galaxy.Entanglion);
       const PHI_PLUS = new Planet('PHI PLUS', Galaxy.Entanglion);
       const PHI_MINUS = new Planet('PHI MINUS', Galaxy.Entanglion);
       const OMEGA0 = new Planet('OMEGA ZERO', Galaxy.Entanglion);
       const OMEGA1 = new Planet('OMEGA ONE', Galaxy.Entanglion);
       const OMEGA2 = new Planet('OMEGA TWO', Galaxy.Entanglion);
       const OMEGA3 = new Planet('OMEGA THREE', Galaxy.Entanglion);
...
OMEGA3.set_transitions(x => PHI_MINUS, x => OMEGA2, x => OMEGA2, Color.Red);
       ...
       const CLOCKWISE_TABLE = [OMEGA0, OMEGA1, PSI_MINUS, PHI_MINUS, OMEGA3, OMEGA2, PHI_PLUS, PSI_PLUS];
